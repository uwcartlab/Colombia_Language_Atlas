...
(function(){
    ...
    if (document.body.offsetWidth <= 768){
        ...
        if (language == "espanol")
            popupContent = '<p>Utilice la tabla para filtrar la lista de participantes. <img width="25" id="right" class="invert-arrow" src="./img/icons/arrow.png"></p><p>Haga clic en los departamentos en el mapa para ver los participantes de ese departamento. <img id="down" class="invert-arrow" width="10%" src="./img/icons/arrow.png"></p>';
        if (language == "english")
            popupContent = '<p>Use table to filter list of participants. <img width="25" id="right" class="invert-arrow" src="./img/icons/arrow.png"></p><p>Tap departments on the map to view participants from that department.<img id="down" class="invert-arrow" width="10%" src="./img/icons/arrow.png"></p>';
    }
    ...
    info.onAdd = function(map) {
        ...
        this._div.innerHTML = '<button id="reset-small-screen" class="reset" style="display:none"><img src="./img/icons/arrow.png"></button><button id="table-button"><img src="./img/icons/person.png"></button><button id="in"><a href="index.html"><img id="info-button" src="./img/icons/info.png"></a></button>';
        return this._div;
    };
    info.addTo(map)
            ...
            fetch("data/colombia_language_data.csv")
                ...
                function createAudio(b){
                    ...
                    document.querySelector("#" + id).addEventListener("click",function(){    
                        ...
                        document.querySelector("body").insertAdjacentHTML("afterbegin","<div class='audio-table'><h2 id='participant'>" + id + "<button id='close-audio'><img src='./img/icons/arrow.png'></button></h2></div")
